<template>
    ...
    <img src="../images/logo.png" class="object-contain h-32 w-18 rounded mt-10 animate-pulse" />
    ...
    <div class="mt-2 flex flex-row text-center justify-center self-center space-x-2">
      ...
      <a href="https://google.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-box-archive" />  Marketplace </a>
      <p class="text-white text-md py-2"> Or </p>
      <a href="https://google.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-store" /> Inworld Store </a>
    </div>
