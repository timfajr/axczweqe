<template>
    ...
    <div class="mt-2 flex flex-row text-center justify-center self-center space-x-2">
      <p class="text-white text-md py-2">Contact Our </p>
      <a href="https://google.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-box-archive" />  Administrator </a>
      <p class="text-white text-md py-2"> Or </p>
      <a href="https://google.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-store" /> Customer Support </a>
    </div>
    <a href="secondlife:///app/agent/439c4909-5e04-4ddc-80d9-a7dda347fb5d/about" class="absolute right-10 bottom-6 flex text-center justify-center self-center text-white pt-10 text-sm">Developed For Private Usage 🚀</a>
    </div>
    </div>
    </body>
